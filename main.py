...
class ColorDetectorApp:
    ...
    def setup_ui(self):
        ...
        self.style.configure(
            "Color.TLabel", font=("Consolas", 11), foreground=self.text_primary
        )
        ...
        labels_with_copy = [
            ...
            (
                ...
                lambda: pyperclip.copy(
                    f"{self.current_rgb[0]}, {self.current_rgb[1]}, {self.current_rgb[2]}"
                ),
            ),
        ]
        ...
        ttk.Label(history_frame, text="COLOR HISTORY", style="Title.TLabel").pack(
            anchor=tk.W
        )

        # History swatches container
        self.history_swatches = ttk.Frame(history_frame, style="History.TFrame")
